...
function getDifferentTypes(text) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            fruitsRankingVal.forEach(element => {
                item_name.push(element[1].item_name.substring(0,4)+"...");
            ...
            option = {
                tooltip: {
                    ...
                    formatter: function (params) {
                        console.log(params)
                        return "< span style='display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#4ad2ff;'></span> " + params[0].name + ': ' + params[0].value + '次';
                       // 鼠标移上显示的文字
                       //1.span是小蓝点
