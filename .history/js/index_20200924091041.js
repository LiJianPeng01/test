...
function getData() {
    ...
    $.ajax({
        ...
        success: function (res) {
            console.log(res.source[0][0]);
            console.log(res.source[0][1]);
            var title = res.source ;
            $(".top_product_title > li").each(function(index){
                $(".top_product_title > li:nth-child("+(index+1)+")").html(title[0][index].substring(0, 4) + "...")
            })

            // $(".top_product_title > li:nth-child(1) > span").html(title[0][0].substring(0, 4) + "...");
            // $(".top_product_title > li:nth-child(1) > span").attr("title",title[0][0]);
            // $(".top_product_title > li:nth-child(2) > span").html(title[0][1].substring(0, 4) + "...")
            // $(".top_product_title > li:nth-child(2) > span").attr("title",title[0][1]);
            // $(".top_product_title > li:nth-child(3) > span").html(title[0][2].substring(0, 4) + "...")
            // $(".top_product_title > li:nth-child(3) > span").attr("title",title[0][2]);
        }
    });
}
