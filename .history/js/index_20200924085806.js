...
function getData() {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $(".top_product_title > li").each(function(index , element){
                console.log(index ,element)
                $(this).children().html(title[0][index])
            })
            $(".top_product_title > li > span:nth-child(1)").html(title[0][0])
            $(".top_product_title > li > span:nth-child(2)").html(title[0][1])
            $(".top_product_title > li > span:nth-child(3)").html(title[0][2])
        }
    });
}
