...
function getData() {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $(".top_product_title > li:nth-child(1) > span").html(title[0][0])
            $(".top_product_title > li:nth-child(2) > span").html(title[0][1])
            $(".top_product_title > li:nth-child(3) > span").html(title[0][2])
        }
    });
}
